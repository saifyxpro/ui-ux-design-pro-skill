...
APCA (Accessible Perceptual Contrast Algorithm) measures polarity — dark-on-light reads differently from light-on-dark. Check values in both modes. APCA is recommended by WCAG 3.0 draft.
