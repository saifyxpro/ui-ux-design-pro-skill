...
| `data/ui-reasoning.csv`      | 143  | Design rules (Layout Priority, 2-Sided Bars, Rule of 4&2)    |
| `data/ux-guidelines.csv`     | 137  | UX guidelines (Sidebar Grouping, Brevity, 8-Pt Grid)         |
